...
export const STR = {
  "en": {
    ...
    "moreThanTitle": "What we match on",
    "moreThanBody": "A verified request is matched against everyone signed up: skill, location, availability and what someone can bring.",
    ...
    "trustTitle": "Checks and safeguards",
    ...
    "ctaTitle": "Sign-ups are open. Add yourself, or post a need.",
    ...
    "trackerIntro": "Anonymous totals from everyone signed up. No personal details appear here.",
  ...
  "np": {
    ...
    "moreThanTitle": "केका आधारमा मिलाउँछौं",
    "moreThanBody": "प्रमाणित अनुरोधलाई दर्ता भएका सबैसँग मिलाइन्छ: सीप, स्थान, उपलब्धता र कसले के ल्याउन सक्छ।",
    ...
    "trackerIntro": "दर्ता भएका सबैको गुमनाम जोड। यहाँ कुनै व्यक्तिगत विवरण देखिँदैन।",
...
export const NP_MAP: Record<string, string> = {
  ...
  "Stopping misuse": "दुरुपयोग रोक्ने",
