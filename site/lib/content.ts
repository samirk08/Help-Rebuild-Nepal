...
export const STR = {
  "en": {
    ...
    "heroSub": "Offer your time, skills or equipment, or tell us what your community needs. We connect verified needs with people ready to help.",
    ...
    "moreThanBody": "We match each verified request to people with the right skills, location and availability.",
    ...
    "trustIntro": "Nothing is published on a form alone. Here is who checks a request, and what happens when one cannot be checked.",
    ...
    "queueEmptyBody": "Submitted requests land here for a municipality or partner to confirm before publishing.",
    ...
    "partnersIntro": "For municipalities, agencies and partner organizations: verification queues, matching, project oversight and handover.",
    ...
    "ctaBody": "Every profile makes the next match faster. Every verified need sharpens the picture of what the country needs.",
    ...
    "organizeBody": "Organizers matter as much as engineers. If you can make calls, keep lists, translate, drive or run a schedule, register. Coordinators are what connect verified needs to available volunteers.",
    ...
    "needsIntro": "Every verified request, filterable by location, skill and urgency. Unverified community reports are listed separately.",
    ...
    "trackerIntro": "Anonymous counts of collective capacity. No personal details are shown.",
    ...
    "adminIntro": "Back-end view for the coordination team: verification queues, matching, project oversight and handover.",
  ...
  "np": {
    ...
    "heroSub": "तपाईंको समय, सीप वा उपकरण दिनुहोस्, वा समुदायलाई के चाहिएको छ भन्नुहोस्। हामी प्रमाणित आवश्यकतालाई सहयोग गर्न तयार मानिससँग जोड्छौं।",
    ...
    "moreThanBody": "हामी प्रत्येक प्रमाणित अनुरोधलाई सही सीप, स्थान र उपलब्धता भएका व्यक्तिसँग जोड्छौं।",
    ...
    "trustIntro": "फारम भरेको भरमा केही पनि प्रकाशित हुँदैन। अनुरोध कसले जाँच्छ र जाँच्न नसकिँदा के हुन्छ, यहाँ हेर्नुहोस्।",
    ...
    "queueEmptyBody": "पेश भएका अनुरोध प्रकाशित हुनुअघि नगरपालिका वा साझेदारले पुष्टि गर्न यहाँ आउँछन्।",
    ...
    "partnersIntro": "नगरपालिका, निकाय र साझेदार संस्थाका लागि: प्रमाणीकरण लाइन, म्याचिङ, परियोजना निगरानी र हस्तान्तरण।",
    ...
    "jA": "क. मलाई सहयोग गर्नु छ",
    "jEngine": "म्याचिङ इन्जिन",
    "jB": "ख. मलाई सहयोग चाहियो",
    ...
    "ctaBody": "प्रत्येक प्रोफाइलले अर्को म्याच छिटो बनाउँछ। प्रत्येक प्रमाणित आवश्यकताले देशलाई के चाहिएको छ भन्ने तस्बिर स्पष्ट बनाउँछ।",
    ...
    "organizeBody": "संयोजक इन्जिनियर जत्तिकै महत्त्वपूर्ण हुन्छन्। फोन गर्न, सूची राख्न, अनुवाद गर्न, सवारी चलाउन वा तालिका मिलाउन सक्नुहुन्छ भने दर्ता गर्नुहोस्। संयोजकहरूले नै प्रमाणित आवश्यकतालाई उपलब्ध स्वयंसेवकसँग जोड्छन्।",
    ...
    "needsIntro": "प्रत्येक प्रमाणित अनुरोध, स्थान, सीप र अत्यावश्यकता अनुसार छान्न मिल्ने। प्रमाणीकरण बाँकी समुदायिक आवश्यकता छुट्टै सूचीबद्ध हुन्छ।",
    ...
    "trackerIntro": "सामूहिक क्षमताको गुमनाम गणना। कुनै व्यक्तिगत विवरण देखाइँदैन।",
    ...
    "adminIntro": "समन्वय टोलीको लागि ब्याक-एन्ड दृश्य: प्रमाणीकरण लाइन, म्याचिङ, परियोजना निगरानी र हस्तान्तरण।",
